...
const IncomePieScreen = () => {
  ...
  const totalAmountPercent = 100 / expenseDatasCtx.getIncome();

  function RenderPieList() {
    const datas = expenseDatasCtx.getCategorys().filter((data) => data.income !== 0);
    ...
    for (let index = 0; index < datas.length; index++) {
      ...
      const elementAmountWithPercent = (totalAmountPercent * element.income).toFixed(2);
...
export default IncomePieScreen;
